"""
Django settings for TaBuddy project.
...
SECRET_KEY = 'django-insecure-&#djpaeqri*-d#pp1nd7sv_#p9*82zs2e&=&5^6*w6cwft8cfb'
...
WSGI_APPLICATION = 'TaBuddy.wsgi.application'
...
DEVICE = os.getenv("DEVICE", "cuda:3")

LOG_DIR = os.getenv("LOG_DIR", os.path.join(BASE_DIR, "logs"))


FLOWER_ENDPOINT = "http://tabuddy_flower:5555"
